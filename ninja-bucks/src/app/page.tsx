...
import NinjaDash from './components/ninjaDash';
...
export default function Home() {
  ...
  const handleLogout = () => {
    setLoggedIn(null); // This will cause the component to re-render and show the login screen
  };
  ...
  return (
    <SnackbarProvider>
      {!loggedIn ? (
        ...
        <NinjaDash name={loggedIn} onLogout={handleLogout} />
      )}
    </SnackbarProvider>
  );
}
